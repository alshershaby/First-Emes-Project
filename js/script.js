...
var prevscrollpos = window.pageYOffset,
  ...
  if(prevscrollpos > currentScrollpos) {
    ...
    document.getElementById("main_navbar").style.top = "-500px";
...
$(function() {
    ...
    $('.slider, .carousel-item, #main,.contries,.sign-container').height(winh);
  ...
  $(".search-btn").click(function(){
    ...
    $(".search-submit").toggle(500);
    $(".career-search-field").toggle(500);
  })
...
$(".nav-services-links").on('click',function(){
  $(".service-table").toggle(function(){
    $(".service-table").css("display","flex",function(){
      $(".service-table").css("display","none");
    })
  });
});
